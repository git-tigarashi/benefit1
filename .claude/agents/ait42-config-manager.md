...
vault kv put secret/staging/stripe \
  secret_key=sk_test_staging_51234567890 \
...
# Add custom patterns
git secrets --add 'sk_live_<REDACTED>[a-zA-Z0-9]{24}' # Stripe live keys
...
const stripe = new Stripe('sk_live_<REDACTED>');
...
STRIPE_SECRET_KEY=sk_live_<REDACTED>  # Production secret in dev!
...
# External Services
# ====================
STRIPE_SECRET_KEY=sk_test_xxxxx  # Stripe API key (test mode)
...
# Apply Terraform
# terraform apply -var="database_url=postgresql://..." -var="stripe_secret_key=sk_live_<REDACTED>..."
```
